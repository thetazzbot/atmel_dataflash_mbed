...
{
    if (m_writeProtectPin != NC)
        m_writeProtectPin = LOW;
}
...
{
    if (m_writeProtectPin != NC)
        m_writeProtectPin = HIGH;
}

/** Get chip Select (CS) pin **/
inline DigitalOut DataFlash::chipSelectPin() const
{
    return m_chipSelectPin;
}

/** Get reset (RESET) pin **/
inline DigitalOut DataFlash::resetPin() const
{
    return m_resetPin;
}

/** Get write protect (WP) pin **/
inline DigitalOut DataFlash::writeProtectPin() const
{
